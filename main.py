...
def get_whale_premium(flow):
    ...
    return call_premium, whale_type, gamma_squeeze
...
async def fvg_whale_scan(verify_with_cheddar=True):
    ...
    for symbol in UNIVERSE:
        ...
        whale, whale_type, gamma_squeeze = get_whale_premium(flow_data)
        if whale < 200000:
            continue
...
# (rest of the script is the same as your original, with check_rollovers, sector_rotation, backtest, scheduler)
